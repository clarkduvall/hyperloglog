...
func TestEB32(t *testing.T) {
	...
	if n != 0x3fffff { t.Error(n) }

	n = eb32(0xf001, 32, 16)
	if n != 0 { t.Error(n) }

	n = eb32(0xf001, 16, 0)
	if n != 0xf001 { t.Error(n) }

	n = eb32(0xf001, 12, 0)
	if n != 1 { t.Error(n) }

	n = eb32(0xf001, 16, 1)
	if n != 0x7800 { t.Error(n) }

	n = eb32(0x1211, 13, 2)
	if n != 0x484 { t.Error(n) }

	n = eb32(0x10000000, 32, 1)
	if n != 0x8000000 { t.Error(n) }
}
...
func TestEB64(t *testing.T) {
	...
	if n != 0xffffffffffffffff { t.Error(n) }

	n = eb64(0xffffffffffffffff, 68, 0)
	if n != 0xffffffffffffffff { t.Error(n) }

	n = eb64(0xffffffffffffffff, 64, 10)
	if n != 0x3fffffffffffff { t.Error(n) }
